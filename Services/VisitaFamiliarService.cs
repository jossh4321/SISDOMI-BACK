...
namespace SISDOMI.Services
{
    public class VisitaFamiliarService
    {
        ...
        public VisitaFamiliarService(ISysdomiDatabaseSettings settings, FaseService faseService, IDocument document, ExpedienteService expedienteService)
        {
        ...
        public async Task<List<VisitaFamiliarDTO>> GetAll(String fromDate, String toDate)
        {
            ...
            List<VisitaFamiliarDTO> listainformes = new List<VisitaFamiliarDTO>();
            ...
            listainformes = await _documentos.Aggregate()
                            ...
                            .AppendStage<VisitaFamiliarDTO>(project)
                            .ToListAsync();
        ...
        public async Task<VisitaFamiliar> RegistrarVisitaFamiliar(VisitaFamiliar informe)
        {
        ...
        //Modificar Informes
        public async Task<VisitaFamiliar> ModificarVisitaFamiliar(VisitaFamiliar informe)
        {
